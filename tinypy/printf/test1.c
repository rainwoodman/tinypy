...
#include <stdlib.h>
#include <string.h>
#define mini_printf_object_t char*
...
int main(void)
{
    ...
    char buff[30];
    mini_snprintf(buff, sizeof buff, "%07d %7d %010d", 1, 2, 3);
    puts(buff);
    mini_snprintf(buff, sizeof buff, "%07lX %7lX %016lX", 0xffffffffffL, 0xffffffffffL, 0xffffffffffL);
    puts(buff);
    mini_snprintf(buff, sizeof buff, "%010o %04o", "object1", "object2");
    puts(buff);
